/**
 * @author Dor Huri
 * class represent binary expression of type xor
 */
public class Xor extends BinaryExpression {
    /**
     * this method is the constructor method for class xor.
    ...
    /**
     * this method evaluate the xor expression and returning the result. If the expression
    ...
    public Boolean evaluate() throws Exception {
        try {
            ...
            //returning the xor of the expression
            return ex1 ^ ex2;
    ...
    public Expression assign(String var, Expression expression) {
        ...
        //returning the xor expression value
        return new Xor(e1, e2);
    }
    /**
     * this method return the xor expression as a string.
    ...
    /**
     * this method return the xor expression according to the nand logic gate for xor operator.
     * @return the expression with only nand operator
     */
    @Override
    public Expression nandify() {
        //returning the expression with only nand operator according to nand logic xor gate
        return new Nand(new Nand(super.getEx1().nandify(), new Nand(super.getEx1().nandify(),
                super.getEx2().nandify())), new Nand(super.getEx2().nandify(), new Nand(super.getEx1().nandify(),
                super.getEx2().nandify())));
    }
    /**
     * this method return the xor expression according to the nor logic gate for xor operator.
     * @return the expression with only nor operator
     */
    @Override
    public Expression norify() {
        //returning the expression with only nor operator according to nor logic xor gate
        return new Nor(new Nor(new Nor(super.getEx1().norify(), super.getEx1().norify()),
                new Nor(super.getEx2().norify(), super.getEx2().norify())), new Nor(super.getEx1().norify(),
                super.getEx2().norify()));
    }
    /**
    ...
    public Expression simplify() {
        //creating a new binary expression of type xor from the simplified expression
        BinaryExpression exp = new Xor(super.getEx1().simplify(), super.getEx2().simplify());
        try {
